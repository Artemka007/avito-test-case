...
export const AiTooltip = ({
  ...
  if (error) {
    return (
      <div className="absolute bottom-full left-0 z-20 mb-3 w-[332px] rounded border border-[#FFCCC7] bg-[#FFF1F0] p-4 shadow-[0_2px_8px_rgba(0,0,0,0.15)]">
        <p className="font-body-sm-strong mb-2 text-[#CF1322]">
          Ошибка запроса к AI
        </p>
        <p className="font-body-sm mb-2 text-[#CF1322] opacity-80">
        ...
        <Button
          ...
          variant="gray"
          onClick={onClose}
          className="rounded-xs px-[7px] py-0"
        >
          Закрыть
        </Button>
  ...
  return (
    <div className="absolute bottom-full left-0 z-20 mb-3 w-[332px] rounded border border-[var(--border)] bg-white p-4 shadow-[0_2px_8px_rgba(0,0,0,0.15)]">
      <p className="font-body-sm-strong mb-2 text-[var(--text-primary)]">
        Ответ AI:
      </p>
      <p className="font-body-sm mb-2 line-clamp-6 whitespace-pre-wrap text-[var(--text-primary)]">
        {result}
      </p>
